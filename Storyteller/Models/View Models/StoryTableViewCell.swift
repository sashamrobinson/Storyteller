...
struct StoryTableViewCell_Previews: PreviewProvider {
    static var previews: some View {
        StoryTableViewCell(allowedToEdit: false, story: Story(storyId: "StoryID", author: "Sasha", authorUid: "UID", dateCreated: "Aug 11, 2023", title: "A Walk Through The Park", published: true, conversation: [], summary: "Summary", genres: [], numberOfLikes: 5, imageUrl: "https://firebasestorage.googleapis.com:443/v0/b/storyteller-ac7f7.appspot.com/o/oBkVshYKMxUysjMKTGiF8mHC19B3%2B9uFALtkJqDbuES0QwnaN?alt=media&token=3e33dd29-1918-4cf1-a398-46ff36734ce5"))
    }
}
